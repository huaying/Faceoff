...
class SelectWeaponScene: SKScene {
    ...
    override func touchesEnded(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        for touch: AnyObject in touches {
            ...
            if return_btn.containsPoint(location) {
                
                return_btn.runAction(SKAction.playSoundFileNamed(FaceoffGameSceneEffectAudioName.ButtonAudioName.rawValue, waitForCompletion: false))
